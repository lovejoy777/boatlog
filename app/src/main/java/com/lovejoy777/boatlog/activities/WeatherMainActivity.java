...
import com.lovejoy777.boatlog.AlarmReceiver;
import com.lovejoy777.boatlog.Constants;
import com.lovejoy777.boatlog.R;
import com.lovejoy777.boatlog.adapters.ViewPagerAdapter;
import com.lovejoy777.boatlog.adapters.WeatherRecyclerAdapter;
import com.lovejoy777.boatlog.fragments.RecyclerViewFragment;
import com.lovejoy777.boatlog.models.Weather;
import com.lovejoy777.boatlog.tasks.GenericRequestTask;
import com.lovejoy777.boatlog.tasks.ParseResult;
import com.lovejoy777.boatlog.tasks.TaskOutput;
import com.lovejoy777.boatlog.utils.UnitConvertor;
import com.lovejoy777.boatlog.widgets.AbstractWidgetProvider;
import com.lovejoy777.boatlog.widgets.DashClockWeatherExtension;
...
public class WeatherMainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void preloadWeather() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(WeatherMainActivity.this);
    ...
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(WeatherMainActivity.this);
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            progressDialog.setButton(DialogInterface.BUTTON_NEGATIVE, getString(R.string.dialog_cancel), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    try {
                        locationManager.removeUpdates(WeatherMainActivity.this);
    ...
    class TodayWeatherTask extends GenericRequestTask {
        public TodayWeatherTask(Context context, WeatherMainActivity activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(WeatherMainActivity.this);
            DashClockWeatherExtension.updateDashClock(WeatherMainActivity.this);
        }
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, WeatherMainActivity activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, WeatherMainActivity activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (id) {
                            ...
                            case R.id.action_map:
                                Intent intentMap = new Intent(WeatherMainActivity.this, MapActivity.class);
                                startActivity(intentMap, bndlanimation);
                                break;
                            case R.id.action_graphs:
                                Intent intentGraph = new Intent(WeatherMainActivity.this, GraphActivity.class);
                                startActivity(intentGraph, bndlanimation);
                                break;
                            ...
                            case R.id.action_settings:
                                Intent intentSetting = new Intent(WeatherMainActivity.this, SettingActivity.class);
    ...
    public void onResume() {
        super.onResume();
        if (getTheme(PreferenceManager.getDefaultSharedPreferences(this).getString("theme", "classic")) != theme) {
