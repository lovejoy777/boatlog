...
public class DashClockWeatherExtension extends DashClockExtension {
    private static final Uri URI_BASE = Uri.parse("content://com.lovejoy777.boatlog.authority");
    ...
    protected void onUpdateData(int reason) {
        ...
        try {
            ...
            publishUpdate(new ExtensionData()
                    ...
                    .clickIntent(new Intent(this, WeatherMainActivity.class)));
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private String localize(SharedPreferences sp, String preferenceKey, String defaultValueKey) {
        return WeatherMainActivity.localize(sp, this, preferenceKey, defaultValueKey);
    }
