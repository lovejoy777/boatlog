...
public class EditTripsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NightModeOn) {
            button_saveTrip.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.colorAccent)));
            button_deleteTrip.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.colorAccent)));
        }
