package com.lovejoy777.boatlog.tasks;
...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    Context context;
    WeatherMainActivity activity;
    public int loading = 0;

    public GenericRequestTask(Context context, WeatherMainActivity activity, ProgressDialog progressDialog) {
        ...
        if (response.isEmpty()) {
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    WeatherMainActivity.saveLastUpdateTime(PreferenceManager.getDefaultSharedPreferences(context));
                }
